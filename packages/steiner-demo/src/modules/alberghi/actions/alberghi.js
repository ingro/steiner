...
export const actionTypes = createActionTypes('alberghi');
export const actions = createActions('alberghi', actionTypes);

/***** OLD MODULE *****/

// import helper from 'helpers/steinerHelper';
    
// export const actionTypes = helper.createActionTypes('alberghi');
// export const actions = helper.createActions('alberghi', actionTypes);